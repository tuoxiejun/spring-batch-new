package com.example.chatprer08_2;

import com.example.chatprer08_2.batch.UniqueLastNameValidator;
import com.example.chatprer08_2.domain.Customer;
...
public class MyJobConfig {
    ...
    public ValidatingItemProcessor<Customer> customerValidatingItemProcessor(){
        return new ValidatingItemProcessor<Customer>(uniqueLastNameValidator());
    }
